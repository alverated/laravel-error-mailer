...
<div style="height: 100%;left: 0;margin: 0;padding: 0;position: fixed;top: 0;width: 100%;">
    <div style=" height: 100%;position: relative;">
        <div style="background: none repeat scroll 0 0 #FFFFFF;float: right;height: 100%;overflow: auto;width: 100%;">
            ...
            <div >
                <div style=" background: none repeat scroll 0 0 #F0F0F0;border-left: 5px solid #EDA31A;display: block;padding: 20px;">
                    <div style="background: none repeat scroll 0 0 #ED591A;color: #FFFFFF;font-size: 11px;font-weight: normal;padding: 10px;font-family: 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;word-wrap: break-word;">
                        {{$subject_line}}
...
<pre style="white-space: pre !important; overflow: auto; background: none repeat scroll 0 0 #272727;color: #929292;font-family: 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;font-size: 11px;font-weight: normal;    line-height: 1.5em; box-shadow: 0 0 6px rgba(0, 0, 0, 0.3) inset;margin: 0;padding: 10px;">
{{trim($output)}}
</pre>
<pre style="white-space: pre !important; overflow: auto; background: none repeat scroll 0 0 #272727;color: #929292;font-family: 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;font-size: 11px;font-weight: normal;    line-height: 1.5em; box-shadow: 0 0 6px rgba(0, 0, 0, 0.3) inset;margin: 0;padding: 10px;">
{{trim($error)}}
</pre>
                    <div style="padding: 8px 15px; background: none repeat scroll 0 0 #404040;border-top: medium none;font-size: 12px; color: #828282;">
                        By: {{ $reported_by }}
                    </div>
                </div>
            </div>
            ...
            <div class="details" style=" border-left: 5px solid rgba(0, 0, 0, 0.2);padding: 10px 20px;">
                <div class="data-table-container" id="data-tables">
                    <div class="data-table" id="sg-serverrequest-data" style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                        ...
                        @if(!empty($input_get))
                            <table style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                                @foreach($input_get as $key=>$val)
                                    <tr>
                                        <td style=" color: #463C54;min-width: 130px;overflow: hidden;padding-right: 5px;width: 20%;">{{$key}}</td>
                                        <td style="width: 80%;color:#999;-ms-word-break: break-all;word-break: break-all;word-break: break-all;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;">{{print_r($val,true)}}</td>
                                    </tr>
                                @endforeach
                            </table>
                        @else
                        ...
                        @if(!empty($input_post))
                            <table style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                                @foreach($input_post as $key=>$val)
                                    <tr>
                                        <td style=" color: #463C54;min-width: 130px;overflow: hidden;padding-right: 5px;width: 20%;">{{$key}}</td>
                                        <td style="width: 80%;color:#999;-ms-word-break: break-all;word-break: break-all;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;">{{print_r($val,true)}}</td>
                                    </tr>
                                @endforeach
                            </table>
                        @else
                        ...
                        @if(!empty($file))
                            <table class="data-table"
                                   style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                        ...
                        <div style="margin: 10px 0;width: 100%; font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;">
                        ...
                        @if(!empty($server))
                            <table style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                                ...
                                @foreach($server as $key=>$val)
                                    <tr>
                                        <td style="white-space: nowrap; color: #463C54;min-width: 130px;overflow: hidden;padding-right: 5px;width: 20%; ">{{$key}}</td>
                                        <td style="white-space: nowrap; width: 80%;color:#999;-ms-word-break: break-all;word-break: break-all;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;">{{is_string($val)?$val:json_encode($val)}}</td>
                                    </tr>
                                @endforeach
                            </table>
                        @else
                        ...
                        @if(!empty($header))
                            <table style="font: 12px 'Source Code Pro',Monaco,Consolas,'Lucida Console',monospace;margin: 10px 0;width: 100%;">
                                @foreach($header as $key=>$val)
                                    <tr>
                                        <td style="white-space: nowrap; color: #463C54;min-width: 130px;overflow: hidden;padding-right: 5px;width: 20%;">{{$key}}</td>
                                        <td style="white-space: nowrap; width: 80%;color:#999;-ms-word-break: break-all;word-break: break-all;-webkit-hyphens: auto;-moz-hyphens: auto;hyphens: auto;">{{implode(',', $val)}}</td>
                                    </tr>
                                @endforeach
                            </table>
                        @else
